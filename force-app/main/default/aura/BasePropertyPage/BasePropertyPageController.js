({
    handleClick: function (cmp, event, helper) {
        ...
        cmpEvent.setParams({
            "changedStrategyNode": cmp.get("v._currentNodeEditable"),
    ...
    handleCurrentNodeChange: function (component, event, helper) {
        ...
        component.set('v._currentNodeEditable', currentNode ? _utils.clone(currentNode, true) : null);
    },

    handleTypeChange: function (cmp, event, helper) {
        var curNode = cmp.get("v._currentNodeEditable");
        if (curNode)
    ...
    resetPage: function (cmp, event, helper) {
        cmp.set("v.currentNode", cmp.get("v._currentNodeEditable"));
    },
    ...
    hasChanges: function (component, event, helper) {
        ...
        var actualState = component.get('v._currentNodeEditable');
