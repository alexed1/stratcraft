({
    doInit: function (cmp, event, helper) {
        ...
        var definition = "{expressions: {\"222\": \"$Record.Is_Qualifying_Stay__C == true || $Record.Loyalty_Level__c =‘Platinum Elite’\",\"GT10Stays\": \"$Record.Loyalty_Level__c ='Platinum Elite'\", \"TravelDisruption\": \"$Record.Loyalty_Level__c ='Gold Elite'\"},onlyFirstMatch: true}";
